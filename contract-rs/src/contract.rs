...
pub const USER_REGISTRATION_STORAGE_USAGE_DEPOSIT: u128 = NearToken::from_millinear(10).as_yoctonear();
pub const USER_TASK_CREATION_STORAGE_USAGE_DEPOSIT: u128 = NearToken::from_millinear(10).as_yoctonear();

pub const NESCROW_OWNER_FEE: Decimal = dec!(0.005);
